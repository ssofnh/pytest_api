# -*- coding: utf-8 -*-
# @Time    : 2022/11/14 9:16
# @Author  : linwei
import json
import time


# from api.hthl_encrypt_api.functions.A01_utils import A01_utils
# from api.task_dispatch_center.task_dispatching_center import run_task_dispatching
# from sql.channel_simulation import Sumpay
# from testdata.Generate_test_data import Generate_test_data
...
class A01(Api_Public_Method):
    # 企业注册入网（A01）

    def __init__(self, type=ProductEnum.ENTERPRISE_REGISTER):
        super().__init__(type=type)

    def A01_FUN1(self):
        data = {
            'clientOrderNo': self.clientOrderNo(),  # 注册申请流水号;
            ...
            'shareholders': [
                ...
                # {
                #     'name': '股东2',  # 股东姓名;
                #     'contributeType': '02',  # 出资方式: 01-资金(资本构成) , 02-技术(资本构成) , 03-实物(资本构成) , 04-权利(资本构成) , 05-其他(资本构成);
                #     'contributeProportion': '2',  # 出资比例: 单位：%,不上送百分号, 大于0小于等于100;
                #     'jobTitle': 'CEO2',  # 职务;
                # },
                # {
                #     'name': '股东3',  # 股东姓名;
                #     'contributeType': '03',  # 出资方式: 01-资金(资本构成) , 02-技术(资本构成) , 03-实物(资本构成) , 04-权利(资本构成) , 05-其他(资本构成);
                #     'contributeProportion': '3',  # 出资比例: 单位：%,不上送百分号, 大于0小于等于100;
                #     'jobTitle': 'CEO3',  # 职务;
                # },
                # {
                #     'name': '股东4',  # 股东姓名;
                #     'contributeType': '04',  # 出资方式: 01-资金(资本构成) , 02-技术(资本构成) , 03-实物(资本构成) , 04-权利(资本构成) , 05-其他(资本构成);
                #     'contributeProportion': '4',  # 出资比例: 单位：%,不上送百分号, 大于0小于等于100;
                #     'jobTitle': 'CEO4',  # 职务;
                # },
                # {
                #     'name': '股东5',  # 股东姓名;
                #     'contributeType': '05',  # 出资方式: 01-资金(资本构成) , 02-技术(资本构成) , 03-实物(资本构成) , 04-权利(资本构成) , 05-其他(资本构成);
                #     'contributeProportion': '5',  # 出资比例: 单位：%,不上送百分号, 大于0小于等于100;
                #     'jobTitle': 'CEO5',  # 职务;
                # },
                # {
                #     'name': '股东6',  # 股东姓名;
                #     'contributeType': '01',  # 出资方式: 01-资金(资本构成) , 02-技术(资本构成) , 03-实物(资本构成) , 04-权利(资本构成) , 05-其他(资本构成);
                #     'contributeProportion': '6',  # 出资比例: 单位：%,不上送百分号, 大于0小于等于100;
                #     'jobTitle': 'CEO6',  # 职务;
                # },
                # {
                #     'name': '股东7',  # 股东姓名;
                #     'contributeType': '02',  # 出资方式: 01-资金(资本构成) , 02-技术(资本构成) , 03-实物(资本构成) , 04-权利(资本构成) , 05-其他(资本构成);
                #     'contributeProportion': '7',  # 出资比例: 单位：%,不上送百分号, 大于0小于等于100;
                #     'jobTitle': 'CEO7',  # 职务;
                # },
                # {
                #     'name': '股东8',  # 股东姓名;
                #     'contributeType': '03',  # 出资方式: 01-资金(资本构成) , 02-技术(资本构成) , 03-实物(资本构成) , 04-权利(资本构成) , 05-其他(资本构成);
                #     'contributeProportion': '8',  # 出资比例: 单位：%,不上送百分号, 大于0小于等于100;
                #     'jobTitle': 'CEO8',  # 职务;
                # },
                # {
                #     'name': '股东9',  # 股东姓名;
                #     'contributeType': '04',  # 出资方式: 01-资金(资本构成) , 02-技术(资本构成) , 03-实物(资本构成) , 04-权利(资本构成) , 05-其他(资本构成);
                #     'contributeProportion': '9',  # 出资比例: 单位：%,不上送百分号, 大于0小于等于100;
                #     'jobTitle': 'CEO9',  # 职务;
                # },
                # {
                #     'name': '股东10',  # 股东姓名;
                #     'contributeType': '05',  # 出资方式: 01-资金(资本构成) , 02-技术(资本构成) , 03-实物(资本构成) , 04-权利(资本构成) , 05-其他(资本构成);
                #     'contributeProportion': '10',  # 出资比例: 单位：%,不上送百分号, 大于0小于等于100;
                #     'jobTitle': 'CEO10',  # 职务;
                # }
            ],
            # 受益人信息列表: 至少1条，最多10条;
            'beneficiary': [
                ...
                # {
                #     'name': '受益人2',  # 受益人姓名;
                #     'connectPhone': '18664388002',  # 受益人联系电话;
                # },
                # {
                #     'name': '受益人3',  # 受益人姓名;
                #     'connectPhone': '18664388003',  # 受益人联系电话;
                # },
                # {
                #     'name': '受益人4',  # 受益人姓名;
                #     'connectPhone': '18664388004',  # 受益人联系电话;
                # },
                # {
                #     'name': '受益人5',  # 受益人姓名;
                #     'connectPhone': '18664388005',  # 受益人联系电话;
                # },
                # {
                #     'name': '受益人6',  # 受益人姓名;
                #     'connectPhone': '18664388006',  # 受益人联系电话;
                # },
                # {
                #     'name': '受益人7',  # 受益人姓名;
                #     'connectPhone': '18664388007',  # 受益人联系电话;
                # },
                # {
                #     'name': '受益人8',  # 受益人姓名;
                #     'connectPhone': '18664388008',  # 受益人联系电话;
                # },
                # {
                #     'name': '受益人9',  # 受益人姓名;
                #     'connectPhone': '18664388009',  # 受益人联系电话;
                # },
                # {
                #     'name': '受益人10',  # 受益人姓名;
                #     'connectPhone': '18664388010',  # 受益人联系电话;
                # }
            ]
        }

        self.Interface_template(data=data)
